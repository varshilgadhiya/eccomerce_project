...
export default function AlluserTable({ data }) {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000//${localStorage.getItem("Alluser")}`, { headers: `Bearer ${localStorage.getItem("token")}` })
            .then((value) => {
                ...
                <TableContainer component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        <TableBody>
                            ...
                            data.map((Alluser) =>
                                <TableRow>
                                    <TableCell align="center">{Alluser.name}</TableCell>
                                    <TableCell align="center">{Alluser.email}</TableCell>
                                    <TableCell align="center">{Alluser.phone}</TableCell>
                                    <TableCell align="center">{Alluser.pic}</TableCell>
                                    <TableCell align="center">{Alluser.role}</TableCell>
                                    <TableCell align="center">{Alluser.pass}</TableCell>
                                    <TableCell align="center">{Alluser.conpass}</TableCell>
